...
const RESUMEN_MES = {
  ...
  noticias: [
    { tag: 'Renta variable', accent: '#0A2540',
      ...
      fuente: 'CNBC' },
    { tag: 'Política monetaria', accent: '#15467A',
    ...
    { tag: 'Tecnología e IA', accent: '#0A2540',
      ...
      fuente: 'CNBC' },
    { tag: 'Energía y geopolítica', accent: '#3E5C76',
